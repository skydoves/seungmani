...
public abstract class HttpResponseHandler<T> extends Handler {
     ...
     */
    public abstract void onHttpSuccess(final T resultObj);

    /**
     * access token, refresh token이 모두 만료되어 다시 로그인이 필요한 경우 호출된다.
     * 다시 로그인 창으로 redirect하도록 한다.
     */
    public abstract void onHttpSessionClosedFailure(final APIErrorResult errorResult);
     ...
     */
    public abstract void onHttpFailure(final APIErrorResult errorResult);
}
